...
_G.mouseX = love.mouse.getX
_G.mouseY = love.mouse.getY
...
function love.load()
	...
	if GameSettings.fullscreen then love.window.setMode(0, 0) end
	...
	_G.DISPLAY_WIDTH = SC_WIDTH * display_scale
	_G.DISPLAY_HEIGHT = SC_HEIGHT * display_scale
